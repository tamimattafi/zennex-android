...
class ListAdapter @Inject constructor(presenter: MvpRecyclerContract.Presenter<ListContract.ListItemHolder>, listener : MvpRecyclerContract.Listener)
    : MvpRecyclerAdapter<ListContract.ListItemHolder>(presenter, listener) {
